...
class App extends Component {
  ...
  async loadBlockchainData() {
    ...
    if (tegTokenData) {
      ...
      this.setState({ tegToken })
      let tegTokenBalance = await tegToken.methods.balanceOf(this.state.account).call()
      this.setState({ tegTokenBalance: tegTokenBalance.toString() })
    } else {
  ...
  render() {
    ...
    if(this.state.loading) {
      ...
      content = <Main 
        ...
        tegTokenBalance={this.state.tegTokenBalance}
